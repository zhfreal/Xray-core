...
type MultiplexingConfig struct {
	...
	MinStreams     int32  `protobuf:"varint,7,opt,name=min_streams,json=minStreams,proto3" json:"min_streams,omitempty"`
	MaxStreams     int32  `protobuf:"varint,8,opt,name=max_streams,json=maxStreams,proto3" json:"max_streams,omitempty"`
...
func (x *MultiplexingConfig) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *MultiplexingConfig) GetMaxConnections() int32 {
	if x != nil {
...
func (x *MultiplexingConfig) GetMinStreams() int32 {
	if x != nil {
		return x.MinStreams
	}
	return 0
...
func (x *MultiplexingConfig) GetMaxStreams() int32 {
	if x != nil {
		return x.MaxStreams
	}
	return 0
...
func (x *MultiplexingConfig) GetPadding() bool {
	if x != nil {
		return x.Padding
	}
	return false
...
func (x *MultiplexingConfig) GetBrutal() bool {
	if x != nil {
		return x.Brutal
	}
	return false
...
func (x *MultiplexingConfig) GetBrutalUp() string {
	if x != nil {
		return x.BrutalUp
	}
	return ""
...
const file_app_proxyman_config_proto_rawDesc = "" +
	...
	"\x0ftarget_strategy\x18\x06 \x01(\x0e2'.xray.transport.internet.DomainStrategyR\x0etargetStrategyJ\x04\b\x03\x10\x04\"\x9b\x03\n" +
	...
	"\x0fxudpProxyUDP443\x18\x04 \x01(\tR\x0fxudpProxyUDP443\x12\x1a\n" +
	"\bprotocol\x18\x05 \x01(\tR\bprotocol\x12'\n" +
	"\x0fmax_connections\x18\x06 \x01(\x05R\x0emaxConnections\x12\x1f\n" +
	"\vmin_streams\x18\a \x01(\x05R\n" +
	"minStreams\x12\x1f\n" +
	"\vmax_streams\x18\b \x01(\x05R\n" +
	"maxStreams\x12\x18\n" +
	"\apadding\x18\t \x01(\bR\apadding\x12\x16\n" +
	"\x06brutal\x18\n" +
	" \x01(\bR\x06brutal\x12\x1b\n" +
	"\tbrutal_up\x18\v \x01(\tR\bbrutalUp\x12\x1f\n" +
	"\vbrutal_down\x18\f \x01(\tR\n" +
	"brutalDownBU\n" +
